      ...
      <div className="w-full">
        ...
        <div className="mt-6">
          <div className="sm:col-span-3">
            ...
            <div className="mt-2">
              <input type="text" name="job-title" id="job-title" onChange={(e) => setFormData(prevState => ({...prevState, jobTitle: e.target.value}))} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
            </div>
          </div>
          ...
          <div className="sm:col-span-3">
            ...
            <div className="mt-2">
              <input type="text" name="company-name" id="company-name" onChange={(e) => setFormData(prevState => ({...prevState, companyName: e.target.value}))} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
            </div>
          </div>
